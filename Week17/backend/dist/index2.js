...
app.post("/signup", async (req, res) => {
    try {
        ...
        await pgClient.query("INSERT INTO users (username, email, password) VALUES ($1, $2, $3)", [username, email, password]); // this array format [username , email password will prevent sql injection]
